...
subprojects {
    ...
    tasks.findByName("genSources")?.configure<Task> {
        dependsOn.remove(tasks.named<GenerateSourcesTask>("genSourcesWithCfr"))
        dependsOn.add(tasks.named<GenerateSourcesTask>("genSourcesWithQuiltflower"))
    }
}
